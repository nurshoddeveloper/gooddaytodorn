...
export default (variables /*: * */ = variable) => {
  ...
  const headerTheme = {
    ...
    ".searchBar": {
      ...
      height: variables.toolbarHeight + sbh + variables.searchBarHeight + 21.5,
    },
    ".rounded": {
      "NativeBase.Item": {
        borderRadius:
          platform === "ios" && platformStyle !== "material" ? 9 : 3
      }
    },
    "NativeBase.Left": {
      "NativeBase.Button": {
        ...
        alignSelf: null,
        width: 40 + 15,
        paddingRight: variables.buttonPadding + 15,
    ...
    "NativeBase.Right": {
      ...
      //flex: 1,
      flex: 0,
      width: 40 + 15, //to be equal with left
      alignSelf: "center",
      alignItems: "flex-end",
      flexDirection: "row",
